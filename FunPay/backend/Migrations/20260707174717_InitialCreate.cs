        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_Email_Normalized", "\"Email\" = lower(btrim(\"Email\"))");
                    table.CheckConstraint("CK_Users_Email_NotEmpty", "length(btrim(\"Email\")) > 0");
                    table.CheckConstraint("CK_Users_Nick_Normalized", "\"Nick\" = lower(btrim(\"Nick\"))");
                    table.CheckConstraint("CK_Users_Nick_NotEmpty", "length(btrim(\"Nick\")) > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Price_NotNegative", "\"Price\" >= 0");
                    table.ForeignKey(
